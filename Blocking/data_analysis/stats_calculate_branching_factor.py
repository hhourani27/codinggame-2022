        ...
        with open(join(data_dir,file)) as f:
            ...
            for game_run in data:
                ...
                for transmission in game_run:
                    if transmission[0] == -1:
                        messages = transmission[2]
                        valid_moves = 0
                        for line in reversed(messages):
                            if line.isnumeric():
                                game.append(valid_moves)
                                break
                            else:
                                valid_moves += 1
...
#%%
messages_dir_2 = 'C:/Users/hhour/Desktop/codinggame/Blocking/game_messages/2_player'
result_2 = calculate_branching_factor(messages_dir_2)
messages_dir_3 = 'C:/Users/hhour/Desktop/codinggame/Blocking/game_messages/3_player'
result_3 = calculate_branching_factor(messages_dir_3)
messages_dir_4 = 'C:/Users/hhour/Desktop/codinggame/Blocking/game_messages/4_player'
result_4 = calculate_branching_factor(messages_dir_4)